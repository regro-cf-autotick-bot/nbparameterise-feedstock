...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/nbparameterise-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10467&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/nbparameterise-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `nbparameterise` can be installed with:

```
conda install nbparameterise
```

It is possible to list all of the versions of `nbparameterise` available on your platform with:
